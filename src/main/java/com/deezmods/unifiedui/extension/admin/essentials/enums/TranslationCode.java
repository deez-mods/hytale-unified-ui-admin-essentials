...
public enum TranslationCode {
	...
	COMMAND_ACTIONS_ARG_DROPDOWN_KEY_WHITELIST_STATUS("command.actions.arg.dropdown.key.whitelist.status"),
	COMMAND_WHITELIST_PLAYER_DISPLAY_NAME("command.whitelist.player.display.name"),
	COMMAND_WHITELIST_PLAYER_DESCRIPTION("command.whitelist.player.description"),
	COMMAND_WHITELIST_PLAYER_ARG_DISPLAY_NAME("command.whitelist.player.arg.display.name"),
	COMMAND_WHITELIST_PLAYER_WHITELISTED("command.whitelist.player.whitelisted"),
	...
	MESSAGE_WHITELIST_STATUS_ENABLED("message.whitelist.status.enabled"),
	MESSAGE_WHITELIST_STATUS_DISABLED("message.whitelist.status.disabled"),
	MESSAGE_WHITELIST_PLAYER_ADDED_UNKNOWN("message.whitelist.player.added.unknown"),
	MESSAGE_WHITELIST_PLAYER_ADDED_KNOWN("message.whitelist.player.added.known"),
	MESSAGE_WHITELIST_PLAYER_INVALID("message.whitelist.player.invalid"),
	...
	EXCEPTION_FILE_READ_BANS("exception.file.read.bans"),
	EXCEPTION_FILE_READ_PLAYER("exception.file.read.player"),
	DEFAULT("");
